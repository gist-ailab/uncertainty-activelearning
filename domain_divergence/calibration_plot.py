...
curr_path = os.path.join(args.save_path, f'seed{args.seed}', args.query_algorithm, f'episode{5}')
...
# query_para = torch.load(os.path.join(curr_path, args.dataset,'model.pt'))
...
for batch_idx, (inputs, targets) in enumerate(test_loader):
    ...
    ece += oce_score(outputs, targets, n_bins=10)
print(ece)