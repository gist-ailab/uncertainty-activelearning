...
if __name__ == "__main__":
    ...
    for epi in range(episode):
        ...
        lbl_set = np.array(lbl_set)
        ulbl_set = np.array(ulbl_set)
        selected_set = query_algorithm(model, ulbl_loader, ulbl_set, args.query_algorithm, device, args.addendum)
        selected_set = ulbl_set[selected_set]
        lbl_set = np.concatenate(lbl_set, selected_set)
        ulbl_set = np.delete(ulbl_set, selected_set)
