...
parameter_path = '/home/hinton/NAS_AIlab_dataset/personal/heo_yunjae/Parameters/Uncertainty/pt4al/cifar10/random'
...
if __name__ == '__main__':
    ...
    for cycle in range(CYCLES):
        ...
        if cycle > 0:
            ...
            checkpoint = torch.load(parameter_path+f'/checkpoint/main_{cycle-1}.pth')
